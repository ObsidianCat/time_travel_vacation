...
let AddDestFormComponent = class AddDestFormComponent {
    constructor() {
        ...
        this.artTags = ["Roman", "Greek and Hellenistic", "Baroque", "Renaissance"];
        this.active = true;
        this.model = new destination_1.DestinationModel("Milano", "Italy", [this.historyTags[0], this.historyTags[2]], [], [], []);
...
AddDestFormComponent = __decorate([
    core_1.Component({
